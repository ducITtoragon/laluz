          ...
          ("validate" !== u && "change" !== u) ||
            ...
            r &&
              ...
              ((d = new RegExp(
                ...
                (i = !1))),
            a &&
              ((d = new RegExp(/[\s\#0-9_\-\+\/\(\)\.]/g)),
              0 < o.val().replace(d, "").length &&
                (c
                  .removeClass("woocommerce-validated")
        ...
        if ((t.xhr && t.xhr.abort(), 0 !== e("form.checkout").length)) {
          ...
          _.length &&
            ...
            e("#ship-to-different-address").find("input").is(":checked") &&
              ((u = e("#shipping_country").val()),
              (s = e("#shipping_state").val()),
              (m = e(":input#shipping_postcode").val()),
              (l = e("#shipping_city").val()),
              (h = e(":input#shipping_address_1").val()),
              (p = e(":input#shipping_address_2").val()));
          var f = {
              ...
              success: function (o) {
                if (o && !0 === o.reload) window.location.reload();
                  ...
                  if (
                    ...
                    o &&
                      o.fragments &&
                      (e.each(o.fragments, function (o, c) {
                        (t.fragments && t.fragments[o] === c) ||
                          e(o).replaceWith(c),
                          e(o).unblock();
                      }),
                      (t.fragments = o.fragments)),
                    ...
                    e(".woocommerce-error, .woocommerce-message").remove(),
                      o.messages
                        ? n.prepend(
              ...
              success: function (c) {
                ...
                try {
                  if (
                    "success" !== c.result ||
                    !1 ===
                      o.triggerHandler("checkout_place_order_success", [c, t])
                  )
                    throw "failure" === c.result
                      ? "Result failure"
                      : "Invalid response";
                  -1 === c.redirect.indexOf("https://") ||
                  -1 === c.redirect.indexOf("http://")
                    ? (window.location = c.redirect)
                    : (window.location = decodeURI(c.redirect));
                } catch (i) {
                  if (!0 === c.reload) return void window.location.reload();
                  !0 === c.refresh &&
                    e(document.body).trigger("update_checkout"),
                    c.messages
                      ? t.submit_error(c.messages)
                      : t.submit_error(
    ...
    o = {
      init: function () {
        e(document.body).on("click", "a.showcoupon", this.show_coupon_form),
          ...
          e("form.checkout_coupon").hide().on("submit", this.submit);
      },
