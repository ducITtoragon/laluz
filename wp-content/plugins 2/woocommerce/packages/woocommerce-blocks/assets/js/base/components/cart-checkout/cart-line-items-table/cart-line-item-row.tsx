...
> = forwardRef<HTMLTableRowElement, CartLineItemRowProps>(
  ({ lineItem, onRemove = () => void null, tabIndex }, ref): JSX.Element => {
    ...
    const saleAmountSingle = regularAmountSingle.subtract(purchaseAmountSingle);
    ...
    return (
      ...
      >
        ...
        <td
          ...
          aria-hidden={!objectHasProp(firstImage, "alt") || !firstImage.alt}
        >
              ...
              {showRemoveItemLink && (
                <button
                  ...
                  aria-label={sprintf(
                    ...
                    __("Remove %s from cart", "woo-gutenberg-products-block"),
                    name
                  )}
                  onClick={() => {
                    onRemove();
        ...
        <td className="wc-block-cart-item__total">
          <div className="wc-block-cart-item__total-price-and-sale-badge-wrapper">
            ...
            {quantity > 1 && (
              <ProductSaleBadge
                currency={priceCurrency}
                saleAmount={getAmountFromRawPrice(saleAmount, priceCurrency)}
                format={saleBadgePriceFormat}
              />
            )}
          </div>
