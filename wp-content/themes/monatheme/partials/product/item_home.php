...
<!-- item product  -->
<div class="inner">
    <div class="bg"></div><a class="img-prod" href="<?php echo esc_url($link); ?>"><?php echo $thumbnail; ?></a>
    <div class="wr-info">
        <h3 class="txt-prod tt"><a class="prod-name" href="<?php echo esc_url($link); ?>">
                <!-- category of product  -->
                <?php
        ...
        <a class="txt-prod stt" href="<?php echo esc_url($link); ?>">
            <?php echo $title; ?>
        </a>
