...
if ( class_exists ( 'MonaAdmin' ) ) {
    class MonaSettingOverview extends MonaAdmin {
        ...
        public function __resgsiter_scripts() 
        {
            ...
            // loading js
            wp_enqueue_script( 'mona-script-'.esc_attr( $this->page ).'-template', get_template_directory_uri() . '/core/admin/assets/js/admin-'.esc_attr( $this->page ).'.js', array( 'wp-color-picker' ), $this->version, true );
        ...
        public function __template() 
        {
            ...
            $disUpdate = $this->__field_value( 'disabled_update', true );
            ?>
            <div class="mona-row setN" id="head_footer_code_settings">
                <div class="mona-col-xl full mona--adminNotice">
                    <div class="mona-card">
                        <div class="card-header">
                            <div class="card-title"><?php echo __( 'Thông báo/Cập nhật', 'mona-admin' ) ?></div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="form-field">
                                        ...
                                        mona_render_field_settings(
                                            [
                                                ...
                                                'value'  => $hideAll,
                                                'title'  => __( 'Ẩn tất cả', 'mona-admin' ),
                                                'docs'   => false,
                                            ]
                                        );
                                        ?>
                                        <div class="note-text"><?php echo __( 'Tuỳ chọn này sẽ ẩn tất cả các thẻ thông báo <code>core</code> <code>plugin</code>', 'mona-admin' ) ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
