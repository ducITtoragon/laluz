...
if ( class_exists ( 'MonaAdmin' ) ) {
    class MonaSettingButtons extends MonaAdmin {
        ...
        public function __front_styles()
        {
            ...
            if ( $active ) {
                // loading css
                wp_enqueue_style( 'mona-style-'.esc_attr( $this->page ).'-template', get_template_directory_uri() . '/public/css/mona-call-buttons.css', array(), $this->version );
                // loading js
                wp_enqueue_script( 'mona-script-'.esc_attr( $this->page ).'-template', get_template_directory_uri() . '/public/scripts/mona-call-buttons.js', array(), $this->version, true );
            }
        }
