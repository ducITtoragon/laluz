<?php 
add_action( 'wp_ajax_mona_admin_ajax_update_buttons',  'mona_admin_ajax_update_buttons' ); // login
function mona_admin_ajax_update_buttons() {
    try {
        $formdata = isset( $_POST ) ? $_POST : [];
        // check class 
        $callBack = (new MonaSettingButtons());
